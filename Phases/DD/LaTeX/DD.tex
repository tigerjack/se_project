...
\end{figure}
The above image shows the various System components and their relationship with each other. The following diagrams, on the other hand, show the Class Diagrams for various parts of the System.
