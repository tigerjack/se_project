...
\begin{itemize}
  ...
  more than 3 minutes. In those 3 minutes the Car can be moving or can be standing.
	\item 	As soon as the Car battery status gets below 20% of the full capacity,the Car isn't in a Charging Area, and the Car status isn’t ‘In     
  ...
  is 'UnAvailable' until the battery gets full recharged.
	\item When the Car battery status reaches the 0% of the full capacity the Car stops working and is immediately set as "Unavailable".
