...
\begin{longtable}{|p{0.2\linewidth} | p{0.8\linewidth}|}
	...
	\textbf{Exceptions} & If one hour has passed since the reservation has been made and the \emph{User} has not unlocked the Car then:
		...
		\end{itemize} 
		\smallskip
		If the \emph{User} has already an active registration or he/she is driving a car or the selected car is yet reserved or being driven or not available, the \emph{System} shows an error message to inform him/her.\\ \hline
\end{longtable}
\stepcounter{UseCaseIdCounter}
